<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PersonelTakibi.aspx.cs" Inherits="KartOkuyucu.PersonelTakibi" %>
                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-12 col-xl-auto mt-4">
                           <%-- <asp:Button class=" float-right form-control form-control-solid " ID="btnYeni" runat="server" Text="Yeni Kayıt" />--%>
                                        ...
                                        <tbody>
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" >
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <asp:HiddenField ID="HastaId" runat="server" Value='<%# Eval("Id") %>' />
